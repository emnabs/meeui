...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* createNamespace */ "a"])('alert');
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  render: function render() {
    ...
    var iconStyle = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* isDef */ "f"])(this.iconWidth) && {
      width: Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* addUnit */ "a"])(this.iconWidth)
    };
    ...
    var AlertIcon = slots('icon') || showIcon && typeIcon && h(_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attrs: {
        name: typeIcon,
        color: type
      }
    });
    var CloseIcon = this.closable && h(_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attrs: {
        name: 'mee-icon-close'
      },
      class: bem('close'),
