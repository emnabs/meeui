...
var functional = __webpack_require__(7);
...
var src_icon = __webpack_require__(9);
...
var _createNamespace = Object(create["a" /* createNamespace */])('avatar');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function Avatar(h, props, slots, ctx) {
  ...
  var showTitle = slots.title || Object(utils["isDef"])(title);
  function Label() {
    var showLabel = slots.label || Object(utils["isDef"])(label);
    if (showLabel) {
      return h('div', {
  ...
  function Value() {
    var showValue = slots.default || Object(utils["isDef"])(value);
    if (showValue) {
      return h('div', {
        class: [bem('value', {
          alone: !showTitle
  ...
  }, Object(functional["b" /* inherit */])(ctx)]), [Thumb(), Title(), Value(), RightIcon(), slots.extra == null ? void 0 : slots.extra()]);
}
Avatar.props = Object(esm_extends["a" /* default */])({}, cellProps, router["c" /* routeProps */]);
/* harmony default export */ var avatar = __webpack_exports__["default"] = (createComponent(Avatar));
