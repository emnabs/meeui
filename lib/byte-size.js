...
/* harmony import */ var _tag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
// Utils

 // Types

var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* createNamespace */ "a"])('byte-size');
var createComponent = _createNamespace[0];
function ByteSize(h, props, slots, ctx) {
  ...
  function formatClass(value, index, sizes) {
    ...
    return h(_tag__WEBPACK_IMPORTED_MODULE_2__["default"], {
      attrs: Object.assign({
        mark: props.mark,
        plain: props.plain,
        type: 'default',
  ...
  function Content() {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* byteSize */ "a"])(props.value, 2, 1024, formatClass);
  }
  return Content();
}
ByteSize.props = {
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(ByteSize));
