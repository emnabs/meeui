...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* createNamespace */ "a"])('card');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function Card(h, props, slots, ctx) {
  ...
  var showHeader = props.showHeader && (slots.header || slots.title || Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isDef"])(props.title) || slots.icon || Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isDef"])(props.icon) || slots.subtitle || Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isDef"])(props.subtitle));
  function TitleIcon() {
    if (slots.icon) {
      return slots.icon();
    }
  ...
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_4__[/* inherit */ "b"])(ctx, true)]), [Header(), Body(), Footer()]);
}
var cardProps = {
  tag: String,
  subtitle: String,
...
Card.props = Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, cardProps, _utils_router__WEBPACK_IMPORTED_MODULE_5__[/* routeProps */ "c"]);
