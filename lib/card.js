...
function Card(h, props, slots, ctx) {
  ...
  var showHeader = props.showHeader && (slots.header || slots.title || Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(props.title) || slots.icon || Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(props.icon) || slots.subtitle || Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(props.subtitle));
  function TitleIcon() {
    if (slots.icon) {
      return slots.icon();
    }
