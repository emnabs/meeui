...
/* harmony import */ var _utils_theme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24);
...
/* harmony import */ var _utils_functional__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* createNamespace */ "a"])('color-block');
...
function ColorBlock(h, props, slots, ctx) {
  ...
  var styles = {};
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(props.radius)) {
    styles.overflow = 'hidden';
    styles.borderRadius = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* addUnit */ "a"])(props.radius);
  }
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(color)) {
    if (_utils_theme__WEBPACK_IMPORTED_MODULE_1__[/* THEME_COLORS */ "a"].indexOf(color) !== -1) {
      classes[color] = color;
    } else {
      styles.backgroundColor = color;
      styles.color = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* getContrastYIQ */ "d"])(color);
    }
  } else {
    styles.color = '#000';
  }
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* isDef */ "f"])(props.width)) {
    styles.width = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* addUnit */ "a"])(props.width);
  }
  if (!square && props.height) {
    styles.height = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* addUnit */ "a"])(props.height);
  }
  if (size) {
    classes[size] = size;
  }
  return h('div', _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_0___default()([{
    class: [bem(classes)],
    style: styles
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_5__[/* inherit */ "b"])(ctx, true)]), [props.showText && h('span', {
    class: bem('text')
  }, props.text || color)]);
}
ColorBlock.props = {
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(ColorBlock));
