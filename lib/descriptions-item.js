...
/* harmony import */ var _mixins_relation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14);
...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('descriptions-item');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  mixins: [Object(_mixins_relation__WEBPACK_IMPORTED_MODULE_6__[/* ChildrenMixin */ "a"])('meeDescriptions')],
  props: Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, _utils_router__WEBPACK_IMPORTED_MODULE_5__[/* routeProps */ "c"], {
    dot: Boolean,
    label: String,
    labelClass: String,
    contentClass: String,
  ...
  computed: {
    labelStyles: function style() {
      ...
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(labelWidth)) {
        style['width'] = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(labelWidth);
      }
      return style;
    }
  },
  methods: {
    onClick: function onClick(event) {
      ...
      Object(_utils_router__WEBPACK_IMPORTED_MODULE_5__[/* route */ "b"])(this.$router, this);
    },
    genLabel: function genLabel() {
      var h = this.$createElement;
      var _ref;
      var showLabel = this.slots('label') || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.label);
      if (showLabel) {
        var labelClass = this.labelClass || this.parent.labelClass;
        var labelSuffix = this.labelSuffix || this.parent.labelSuffix;
        return h('dt', {
          class: [bem('label'), labelClass, (_ref = {}, _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_4__[/* BORDER_RIGHT */ "d"]] = this.parent.border, _ref)],
  ...
  render: function render() {
    ...
    return h('dl', {
      class: [bem([labelPosition, labelValign]), (_ref = {}, _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_4__[/* BORDER_BOTTOM */ "b"]] = border, _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_4__[/* BORDER_LEFT */ "c"]] = border, _ref)]
    }, [this.genLabel(), h('dd', {
      attrs: {
