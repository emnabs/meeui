...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    labelStyles: function style() {
      ...
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(labelWidth)) {
  ...
  methods: {
    ...
    genLabel: function genLabel() {
      ...
      var _ref;
      var showLabel = this.slots('label') || Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.label);
      if (showLabel) {
