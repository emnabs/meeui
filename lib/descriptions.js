...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* createNamespace */ "a"])('descriptions');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  mixins: [Object(_mixins_relation__WEBPACK_IMPORTED_MODULE_3__[/* ParentMixin */ "b"])('meeDescriptions')],
  props: {
  ...
  computed: {
    style: function style() {
      ...
      var style = {};
      if (gutter) {
        style['--grid-gap'] = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* addUnit */ "a"])(gutter);
      }
      if (columnNum) {
  ...
  render: function render() {
    ...
    if (this.border && !this.gutter) {
      _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_2__[/* BORDER_RIGHT */ "d"]] = true;
      _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_2__[/* BORDER_TOP_BOTTOM */ "g"]] = true;
    }
    var h = arguments[0];
    var header;
