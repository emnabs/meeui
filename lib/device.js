...
/* harmony import */ var _shapes_icons_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
var _shapes_icons_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(10, 1);
...
var dom_event = __webpack_require__(12);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _utils_functional__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _utils_dom_event__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  render: function render() {
    ...
    }, [this.genIcon(active), h(_info__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
      attrs: {
        dot: this.dot,
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _utils_constant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _utils_interceptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26);
...
// EXTERNAL MODULE: ./src/utils/functional.js
var functional = __webpack_require__(5);

// EXTERNAL MODULE: ./src/nav-bar/index.js
var nav_bar = __webpack_require__(33);

// EXTERNAL MODULE: ./src/tabbar/index.js
var tabbar = __webpack_require__(35);

// EXTERNAL MODULE: ./src/icon/index.js
var icon = __webpack_require__(8);

// EXTERNAL MODULE: ./src/tabbar-item/index.js
var tabbar_item = __webpack_require__(34);

// EXTERNAL MODULE: ./node_modules/dayjs/dayjs.min.js
var dayjs_min = __webpack_require__(30);
...
var _createNamespace = Object(create["a" /* createNamespace */])('status-bar');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function StatusBar(h, props, slots, ctx) {
  ...
  return h('div', helper_default()([{
    class: bem()
  }, Object(functional["b" /* inherit */])(ctx, true)]), [Signal(), Datetime(), Battery()]);
}
StatusBar.props = {
  time: String,
  timeFormat: {
...
/* harmony default export */ var status_bar = (createComponent(StatusBar));
// EXTERNAL MODULE: ./src/search/index.js
...
function Device(h, props, slots, ctx) {
  ...
  function MenuBar() {
    var menus = props.menus.map(item => {
      return h(tabbar_item["default"], {
        attrs: {
          icon: item.icon
        }
      }, [item.text]);
    });
    return h(tabbar["default"], {
  ...
  }, Object(functional["b" /* inherit */])(ctx, true)]), [PageStatusBar(), MpMenuButton(), Header(), Body(), Footer()]);
}
Device.props = {
  tag: String,
  subtitle: String,
...
/* harmony default export */ var device = __webpack_exports__["default"] = (device_createComponent(Device));
