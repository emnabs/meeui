...
var src_icon = __webpack_require__(8);
...
// Utils
 ...
 // Types
// style moved to centralized theme entry
var _createNamespace = Object(create["a" /* createNamespace */])('loading');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
...
/* harmony default export */ var src_loading = (createComponent(Loading));
...
function Button(h, props, slots, ctx) {
  ...
  function onClick(event) {
    ...
    if (!loading && !disabled) {
      ...
      Object(router["a" /* functionalRoute */])(ctx);
    }
  }
  ...
  var classes = [button_bem([type, props.size, {
    ...
    round: props.round,
    square: props.square
  }]), (_ref = {}, _ref[constant["e" /* BORDER_SURROUND */]] = hairline, _ref)];
  function renderIcon() {
    if (loading) {
...
Button.props = Object(esm_extends["a" /* default */])({}, router["c" /* routeProps */], {
  text: String,
  icon: String,
  color: String,
  block: Boolean,
...
/* harmony default export */ var src_button = __webpack_exports__["default"] = (button_createComponent(Button));
...
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _utils_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
// style moved to centralized theme entry
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('goods-action-button');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  mixins: [Object(_mixins_relation__WEBPACK_IMPORTED_MODULE_3__[/* ChildrenMixin */ "a"])('meeGoodsAction')],
  props: Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, _utils_router__WEBPACK_IMPORTED_MODULE_2__[/* routeProps */ "c"], {
    type: String,
    text: String,
    icon: String,
    color: String,
  ...
  methods: {
    onClick: function onClick(event) {
      ...
      Object(_utils_router__WEBPACK_IMPORTED_MODULE_2__[/* route */ "b"])(this.$router, this);
    }
  },
