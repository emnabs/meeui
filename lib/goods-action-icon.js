...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('goods-action-icon');
  ...
  methods: {
    ...
    genIcon: function genIcon() {
      ...
      if (slot) {
        return h('div', {
          class: bem('icon')
        }, [slot, h(_info__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
          attrs: {
            dot: this.dot,
            info: info
          }
