...
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
...
// Utils
 ...
 // Types
// style moved to centralized theme entry
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('tag');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function Tag(h, props, slots, ctx) {
  ...
  var CloseIcon = props.closeable && h(_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    on: {
      click: function click(event) {
        ...
        Object(_utils_functional__WEBPACK_IMPORTED_MODULE_2__[/* emit */ "a"])(ctx, 'close');
      }
    }
  });
  return h('transition', {
  ...
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_2__[/* inherit */ "b"])(ctx, true)]), [slots.default == null ? void 0 : slots.default(), CloseIcon])]);
}
Tag.props = {
  size: String,
  mark: Boolean,
...
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    style: function style() {
      var style = {};
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.width)) {
        style.width = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.width);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.height)) {
        style.height = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.height);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.radius)) {
        style.overflow = 'hidden';
        style.borderRadius = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.radius);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.ratio)) {
  ...
  created: function created() {
    ...
    if ($Lazyload && _utils__WEBPACK_IMPORTED_MODULE_2__["inBrowser"]) {
  ...
  methods: {
    ...
    genPlaceholder: function genPlaceholder() {
      ...
      if (this.loading && this.showLoading) {
        return h('div', {
          class: bem('loading')
        }, [this.slots('loading') || h(_icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
          attrs: {
      ...
      if (this.error && this.showError) {
        return h('div', {
          class: bem('error')
        }, [this.slots('error') || h(_icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
          attrs: {
            name: this.errorIcon,
            classPrefix: this.iconPrefix
          },
    ...
    genImage: function genImage() {
      var h = this.$createElement;
      var imgData = {
        class: [bem('img'), Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.height) && 'auto-width'],
        attrs: {
          alt: this.alt
        },
        style: {
  ...
  render: function render() {
    ...
    return h('div', {
      class: bem({
        round: this.round,
        scale: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.ratio) && this.ratio !== 0,
        autowidth: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(this.height)
      }),
      style: this.style,
      on: {
        click: this.onClick
...
/* harmony import */ var _utils_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* createNamespace */ "a"])('currency');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  props: {
  ...
  computed: {
    capitalText() {
      if (this.capital && this.priceValue) {
        return Object(_utils__WEBPACK_IMPORTED_MODULE_1__["convertCurrency"])(this.priceValue);
      }
      return '';
    },
    priceValue() {
  ...
  render: function render() {
    ...
    var styles = {};
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isDef"])(color)) {
      if (_utils_theme__WEBPACK_IMPORTED_MODULE_2__[/* THEME_COLORS */ "a"].indexOf(color) !== -1) {
        classes.push(color);
      } else {
        styles.color = color;
      }
    ...
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isDef"])(this.capitalText)) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var _utils_functional__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _tag__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24);
/* harmony import */ var _image__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(30);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34);
...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('goods-block');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function GoodsBlock(h, props, slots, ctx) {
  var _slots$priceTop;
  var thumb = props.thumb;
  var showNum = slots.num || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(props.num);
  var showPrice = slots.price || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(props.price);
  var showOriginPrice = slots['origin-price'] || Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDef"])(props.originPrice);
  var showBottom = showNum || showPrice || showOriginPrice || slots.bottom;
  function onThumbClick(event) {
    Object(_utils_functional__WEBPACK_IMPORTED_MODULE_3__[/* emit */ "a"])(ctx, 'click-thumb', event);
  }
  function Badge() {
    if (slots.badge || props.badge) {
      return h('div', {
        class: bem('badge')
      }, [slots.badge ? slots.badge() : h(_tag__WEBPACK_IMPORTED_MODULE_4__["default"], {
        attrs: {
          mark: true,
          type: 'danger'
        }
  ...
  function Thumb() {
    if (slots.thumb || thumb) {
      ...
      }, [slots.thumb ? slots.thumb() : h(_image__WEBPACK_IMPORTED_MODULE_5__["default"], {
        attrs: {
          src: thumb,
          width: '100%',
          height: '100%',
  ...
  function Title() {
    ...
    if (props.title) {
      return h('div', {
        class: [bem('title'), props.titleInner ? bem('title-inner') : 'mee-ellipsis']
      }, [props.title]);
    }
  }
  function Tags() {
    ...
    if (Array.isArray(tags) && tags.length > 0) {
      return h('div', {
        ...
        return isImage(tag) ? h(_image__WEBPACK_IMPORTED_MODULE_5__["default"], {
          attrs: {
            src: tag,
            fit: 'cover',
            'lazy-load': props.lazyLoad
          }
        }) : h(_tag__WEBPACK_IMPORTED_MODULE_4__["default"], {
          attrs: {
            mark: true,
            type: 'danger',
            size: 'small'
  ...
  function PriceContent() {
    return h(_currency__WEBPACK_IMPORTED_MODULE_7__["default"], {
      attrs: {
        value: props.price,
  ...
  return h('div', _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_0___default()([{
    ...
    style: styles
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_3__[/* inherit */ "b"])(ctx, true)]), [Header(), Content(), Footer(), AddIcon()]);
}
GoodsBlock.props = {
  tags: [Array, String],
  badge: String,
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(GoodsBlock));
