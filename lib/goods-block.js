...
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
...
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    style: function style() {
      var style = {};
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.width)) {
        style.width = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.width);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.height)) {
        style.height = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.height);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.radius)) {
        style.overflow = 'hidden';
        style.borderRadius = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(this.radius);
      }
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.ratio)) {
  ...
  created: function created() {
    ...
    if ($Lazyload && _utils__WEBPACK_IMPORTED_MODULE_2__[/* inBrowser */ "e"]) {
  ...
  methods: {
    ...
    genImage: function genImage() {
      var h = this.$createElement;
      var imgData = {
        class: [bem('img'), Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.height) && 'auto-width'],
        attrs: {
          alt: this.alt
        },
        style: {
  ...
  render: function render() {
    ...
    return h('div', {
      class: bem({
        round: this.round,
        scale: Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.ratio) && this.ratio !== 0,
        autowidth: Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(this.height)
      }),
      style: this.style,
      on: {
        click: this.onClick
...
/* harmony import */ var _utils_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    capitalText() {
      if (this.capital && this.priceValue) {
        return Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* convertCurrency */ "b"])(this.priceValue);
      }
      return '';
    },
    priceValue() {
  ...
  render: function render() {
    ...
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* isDef */ "f"])(this.capitalText)) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var _utils_functional__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _tag__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
/* harmony import */ var _image__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31);
...
function GoodsBlock(h, props, slots, ctx) {
  ...
  var showNum = slots.num || Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.num);
  var showPrice = slots.price || Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.price);
  var showOriginPrice = slots['origin-price'] || Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.originPrice);
