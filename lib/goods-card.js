...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('goods-card');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
function GoodsCard(h, props, slots, ctx) {
  ...
  function ThumbTag() {
    if (slots.tag || props.tag) {
      return h('div', {
        class: bem('tag')
      }, [slots.tag ? slots.tag() : h(_tag__WEBPACK_IMPORTED_MODULE_4__["default"], {
        attrs: {
          mark: true,
          type: 'danger'
        }
  ...
  return h('div', _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_0___default()([{
    class: bem()
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_3__[/* inherit */ "b"])(ctx, true)]), [h('div', {
    class: bem('header')
  }, [Thumb(), h('div', {
    class: bem('content', {
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(GoodsCard));
