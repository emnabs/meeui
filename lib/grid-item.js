...
/* harmony import */ var _utils_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _utils_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
/* harmony import */ var _mixins_relation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('grid-item');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  mixins: [Object(_mixins_relation__WEBPACK_IMPORTED_MODULE_5__[/* ChildrenMixin */ "a"])('meeGrid')],
  props: Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, _utils_router__WEBPACK_IMPORTED_MODULE_4__[/* routeProps */ "c"], {
    dot: Boolean,
    text: String,
    icon: String,
    iconPrefix: String,
  ...
  computed: {
    style: function style() {
      ...
      if (square) {
        ...
        var gutterValue = Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* addUnit */ "a"])(gutter);
  ...
  methods: {
    onClick: function onClick(event) {
      ...
      Object(_utils_router__WEBPACK_IMPORTED_MODULE_4__[/* route */ "b"])(this.$router, this);
    },
    genIcon: function genIcon() {
      ...
      if (iconSlot) {
        ...
        }, [iconSlot, h(_info__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
          attrs: {
            dot: this.dot,
            info: info
          }
  ...
  render: function render() {
    ...
    return h('div', {
      ...
      }]), (_ref = {}, _ref[_utils_constant__WEBPACK_IMPORTED_MODULE_3__[/* BORDER */ "a"]] = border, _ref)],
      on: {
        click: this.onClick
      }
    }, [this.genContent()])]);
