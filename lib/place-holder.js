...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('place-holder');
...
function PlaceHolder(h, props, slots, ctx) {
  ...
  return h('div', _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_0___default()([{
    class: bem(classes)
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_2__[/* inherit */ "b"])(ctx, true)]), [Content()]);
}
PlaceHolder.props = {
  bg: String,
  size: String,
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(PlaceHolder));
