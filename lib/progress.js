...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* createNamespace */ "a"])('progress');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
var PERIMETER = 3140;
var uid = 0;
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    ...
    gradient: function gradient() {
      return Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isObject"])(this.color);
    },
  ...
  methods: {
    ...
    genLine() {
      ...
      return h('div', {
        ...
        class: bem('bar-outer'),
        style: {
          height: Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* addUnit */ "a"])(this.strokeWidth)
        }
      }, [h('div', {
        class: bem('bar-inner'),
        style: this.barStyle
    ...
    genCircle() {
      ...
      return h('div', {
        class: bem('circle'),
        style: {
          height: Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* addUnit */ "a"])(this.width),
          width: Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* addUnit */ "a"])(this.width)
        }
      }, [this.genSvg()]);
    },
    ...
    genText() {
      if (this.showText && !this.textInside) {
        ...
        return h('div', {
          class: bem('text'),
          style: {
            fontSize: Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* addUnit */ "a"])(this.progressTextSize)
          }
        }, [!this.status ? this.genContent() : h(_icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
          class: bem('text-icon'),
          attrs: {
            name: this.iconClass,
            color: this.status
  ...
  render: function render() {
    var h = arguments[0];
    return h('div', {
      class: [bem([this.type, !this.showText && 'without-text', this.textInside && 'text-inside']), this.status ? 'is-' + this.status : ''],
      attrs: {
        role: 'progressbar',
