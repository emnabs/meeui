...
// CONCATENATED MODULE: ./src/scalebox/shared.js
var scaleboxProps = {
  size: String,
  width: {
    type: [String, Number],
...
// CONCATENATED MODULE: ./src/scalebox/index.js
...
var _createNamespace = Object(create["a" /* createNamespace */])('scalebox');
...
function Scalebox(h, props, slots, ctx) {
  ...
  if (props.width) {
    styles.push({
      '--scalebox-width': Object(unit["a" /* addUnit */])(props.width)
    });
  }
  ...
  }, Object(functional["b" /* inherit */])(ctx)]), [InnerBox()]);
}
Scalebox.props = Object(esm_extends["a" /* default */])({}, scaleboxProps, router["c" /* routeProps */]);
/* harmony default export */ var scalebox = __webpack_exports__["default"] = (createComponent(Scalebox));
