...
/* harmony default export */ var statistic = __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    ...
    overValueText() {
      if (Object(utils["isDef"])(this.overValue)) {
  ...
  methods: {
    ...
    genValueUnit: function genValueUnit() {
      ...
      const showUnit = slot || Object(utils["isDef"])(valueUnit);
      if (showUnit) {
        return h('small', {
    ...
    genLabel: function genLabel() {
      ...
      const showLabel = slot || Object(utils["isDef"])(label);
      if (showLabel) {
        return h('div', {
    ...
    genBottomBox: function genBottomBox() {
      ...
      const showBottom = bottomSlot || labelSlot || Object(utils["isDef"])(label) || floatValueSlot || offsetRateText;
      if (showBottom) {
        return h('div', {
          class: bem('bottom')
