...
var _createNamespace = Object(create["a" /* createNamespace */])('swipe-cell');
var createComponent = _createNamespace[0];
var bem = _createNamespace[1];
var THRESHOLD = 0.15;
/* harmony default export */ var swipe_cell = __webpack_exports__["default"] = (createComponent({
  ...
  methods: {
    ...
    onTouchMove: function onTouchMove(event) {
      ...
      if (this.direction === 'horizontal') {
        ...
        this.offset = Object(number["b" /* range */])(this.deltaX + this.startOffset, -this.computedRightWidth, this.computedLeftWidth);
      }
    },
