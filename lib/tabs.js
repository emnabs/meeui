...
/* harmony import */ var _utils_format_unit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
/* harmony import */ var _utils_dom_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var _mixins_bind_event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21);
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent({
  ...
  computed: {
    ...
    style: function style() {
      ...
      var style = {};
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isDef"])(this.zIndex)) {
  ...
  created: function created() {
    ...
    if (!_utils__WEBPACK_IMPORTED_MODULE_3__["isServer"] && window.IntersectionObserver) {
...
var relation = __webpack_require__(14);

// EXTERNAL MODULE: ./src/mixins/bind-event.js
var bind_event = __webpack_require__(21);
...
/* harmony default export */ var Title = (createComponent({
  ...
  methods: {
    ...
    genText: function genText() {
      ...
      if (this.dot || Object(utils["isDef"])(this.info) && this.info !== '') {
        return h('span', {
...
var touch = __webpack_require__(26);
  ...
  methods: {
    ...
    setLine: function setLine() {
      ...
      this.$nextTick(function () {
        ...
        if (Object(utils["isDef"])(lineHeight)) {
    ...
    setCurrentIndex: function setCurrentIndex(currentIndex) {
      ...
      if (!Object(utils["isDef"])(newIndex)) {
        return;
      }
