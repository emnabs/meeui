...
var _createNamespace = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* createNamespace */ "a"])('zoom-box');
...
function ZoomBox(h, props, slots, ctx) {
  ...
  var styles = [];
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.background)) {
  ...
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.width)) {
    styles.push({
      width: Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(props.width)
    });
  }
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.radius)) {
    styles.push({
      overflow: 'hidden',
      borderRadius: Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* addUnit */ "a"])(props.radius)
    });
  }
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__[/* isDef */ "f"])(props.ratio)) {
  ...
  return h('div', _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_0___default()([{
    ...
    style: styles
  }, Object(_utils_functional__WEBPACK_IMPORTED_MODULE_4__[/* inherit */ "b"])(ctx, true)]), [Body()]);
}
ZoomBox.props = {
...
/* harmony default export */ __webpack_exports__["default"] = (createComponent(ZoomBox));
